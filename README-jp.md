...
4. プロジェクトの README に dev-charter バッジを追加する（docs/dev-charter/README-jp.md の「Badges for Adopting Projects」参照）
...
4. プロジェクトの README に dev-charter バッジが存在するか確認・追加する（docs/dev-charter/README-jp.md の「Badges for Adopting Projects」参照）
