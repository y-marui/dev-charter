...
典型的なプロジェクト種別と、それぞれの配布形態・ライセンス・マネタイズの傾向を示す。ライセンスとマネタイズの詳細は [LICENSE_POLICY.md](../LICENSE_POLICY.md) と [MONETIZATION_POLICY.md](../MONETIZATION_POLICY.md) を参照すること。
...
ライセンス選択基準・テンプレート全文は [LICENSE_POLICY.md](../LICENSE_POLICY.md) を参照。
AGPL/GPL/LGPL を採用する場合の準 CLA 設定（`CONTRIBUTING.md` + PR テンプレート）は [GITHUB_WORKFLOW.md](../GITHUB_WORKFLOW.md) の `## Contributing Templates` を参照。
...
| `README.md` | ✅ | 英語版（参照） |
| `LICENSE` | ✅ | [LICENSE_POLICY.md](../LICENSE_POLICY.md) に従ったライセンス |
...
[ ] AGPL/GPL/LGPL を採用した場合、`CONTRIBUTING.md` に準 CLA 条項があり、`.github/PULL_REQUEST_TEMPLATE.md` に同意チェックボックスがあるか（[GITHUB_WORKFLOW.md](../GITHUB_WORKFLOW.md) 参照）
...
4. §3 に従い言語ポリシーを決定する
5. [LICENSE_POLICY.md](../LICENSE_POLICY.md) に従い `LICENSE` ファイルを作成する。AGPL/GPL/LGPL を採用する場合は [GITHUB_WORKFLOW.md](../GITHUB_WORKFLOW.md) の準 CLA 設定（`CONTRIBUTING.md` + PR テンプレートへの同意チェックボックス）も行う
