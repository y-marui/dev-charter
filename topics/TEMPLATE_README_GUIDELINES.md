...
4. §3 に従い言語ポリシーを決定する
5. [LICENSE_POLICY.md](../LICENSE_POLICY.md) に従い `LICENSE` ファイルを作成する。AGPL/GPL/LGPL を採用する場合は [GITHUB_CONTRIBUTING.md](GITHUB_CONTRIBUTING.md) の準 CLA 設定（`CONTRIBUTING.md` + PR テンプレートへの同意チェックボックス）も行う
