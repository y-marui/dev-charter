...
```
[![dev-charter](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/{user}/{repo}/main/docs/dev-charter/badge.json)](https://github.com/y-marui/dev-charter)
![Charter Check](https://github.com/{user}/{repo}/actions/workflows/dev-charter-check.yml/badge.svg)
```
...
[ ] dev-charter を導入済みの場合、dev-charter バッジ（version + charter-check）が存在するか（§5.3 参照）
